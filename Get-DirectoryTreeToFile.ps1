# Get-DirectoryTreeToFile.ps1
# Script to generate a directory tree with full paths, save to a file, and copy to clipboard
...
# Output file path
$outputFile = Join-Path -Path $currentDirPath -ChildPath "directory_tree.txt"
...
# Save to file
$xmlOutput | Out-File -FilePath $outputFile

# Copy to clipboard
$xmlOutput | Set-Clipboard

# Notify user
Write-Output "Directory tree saved to: $outputFile"
